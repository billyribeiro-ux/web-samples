...
-- CreateEnum
CREATE TYPE "SessionScope" AS ENUM ('MEMBER', 'ADMIN');
...
-- CreateEnum
CREATE TYPE "ProductType" AS ENUM ('DIGITAL', 'SERVICE', 'PHYSICAL');
...
-- CreateEnum
CREATE TYPE "FormSubmissionType" AS ENUM ('CONTACT', 'NEWSLETTER', 'LEAD', 'SUPPORT', 'CHECKOUT');
...
-- CreateIndex
CREATE UNIQUE INDEX "RateLimitBucket_key_windowKey_key" ON "RateLimitBucket"("key", "windowKey");
