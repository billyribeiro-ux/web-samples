...
-- CreateEnum
CREATE TYPE "GatedResource" AS ENUM ('POST', 'PAGE', 'PRODUCT');
...
CREATE TABLE "Plan" (
    ...
    "amountMonthly" INTEGER,
    "amountYearly" INTEGER,
...
CREATE TABLE "GatedContentRule" (
    "id" TEXT NOT NULL,
    "resourceType" "GatedResource" NOT NULL,
...
-- CreateIndex
CREATE INDEX "GatedContentRule_resourceType_resourceId_idx" ON "GatedContentRule"("resourceType", "resourceId");
...
-- AddForeignKey
ALTER TABLE "GatedContentRule" ADD CONSTRAINT "GatedContentRule_planId_fkey" FOREIGN KEY ("planId") REFERENCES "Plan"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "GatedContentRule" ADD CONSTRAINT "GatedContentRule_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "Role"("id") ON DELETE CASCADE ON UPDATE CASCADE;
